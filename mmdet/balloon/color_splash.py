...
model = init_detector('work_dirs/mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_balloon/mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_balloon.py', 'work_dirs/mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_balloon/epoch_12.pth', device=device)
